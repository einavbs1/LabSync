...
class LabSyncDashBoard(ctk.CTk):
    ...
    def SideBar(self):
        ...
        try:
            ...
            self.LogoIcon = ctk.CTkImage(Image.open(os.path.join(images_folder_path, "LabSyncIcon.png")), size=(300,200))
    ...
    def tabsWidgetsFunc(self):
        ...
        self.tabsWidgets._segmented_button.configure(height=30, width=500, fg_color=("gray85","gray25"), font=ctk.CTkFont(family="Segoe UI Variable", size=14, weight="bold"))
    ...
    def createCard(self, my_master, name="Empty", cardtype: ["zone","AddObject","DeleteWS"]= "AddObject", funcToBtn = None):
        ...
        self.newButton.grid(row=0, column=0, padx=2, pady=2)
